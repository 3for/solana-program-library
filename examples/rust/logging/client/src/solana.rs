...
static PROGRAM_KEYPAIR_PATH: &str = "spl_example_logging-keypair.json";
...
pub fn commit(
    ...
    client: &RpcClient,
    program: &Keypair,
    program_instance_account: &Pubkey,
) -> Result<()> {
    let inst = create_instruction(&program.pubkey(), program_instance_account)?;
...
fn create_instruction(
    ...
    Ok(Instruction {
        ...
        accounts: vec![
            AccountMeta::new(*program_instance_account, false),
        ],
        data,
    })
}
